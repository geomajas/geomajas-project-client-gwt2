 ...
 */
public class FixedScaleLayerRenderer implements LayerRenderer {
		...
		eventBus.addLayerStyleChangedHandler(new LayerStyleChangedHandler() {
			...
			public void onLayerStyleChanged(LayerStyleChangedEvent event) {
				if (layer instanceof RasterServerLayer) {
					container.setOpacity(((RasterServerLayer) layer).getOpacity());
				} else {
					refresh();
				}
			}
	...
	protected FixedScaleRenderer getRendererForView(View view) {
