...
public interface PanControlResource extends ClientBundle {
	...
	/** Background for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl}. */
	@Source("image/map-pan-background.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlBackground();

	/** Top pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl}. */
	@Source("image/map-pan-top.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlTop();

	/** Top pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl} when highlighted. */
	@Source("image/map-pan-top-hover.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlTopHover();

	/** Right pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl}. */
	@Source("image/map-pan-right.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlRight();

	/** Right pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl} when highlighted. */
	@Source("image/map-pan-right-hover.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlRightHover();

	/** Bottom pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl}. */
	@Source("image/map-pan-bottom.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlBottom();

	/** Bottom pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl} when highlighted. */
	@Source("image/map-pan-bottom-hover.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panningBottomHover();

	/** Left pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl}. */
	@Source("image/map-pan-left.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource panControlLeft();

	/** Left pan button for the {@link org.geomajas.gwt2.client.widget.control.pan.PanControl} when highlighted. */
