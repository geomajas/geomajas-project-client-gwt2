...
public class MapConfigurationImpl implements MapConfiguration {
	...
	public MapConfigurationImpl() {
		...
		setHintValue(MapConfiguration.RENDERER_TYPE, RendererType.CANVAS);
	}
	...
	public void setRendererType(RendererType rendererType) {
		setHintValue(MapConfiguration.RENDERER_TYPE, rendererType);
	}

	@Override
	public RendererType getRendererType() {
		return getHintValue(MapConfiguration.RENDERER_TYPE);
	}
