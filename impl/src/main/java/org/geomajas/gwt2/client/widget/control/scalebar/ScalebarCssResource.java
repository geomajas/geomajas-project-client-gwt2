...
public interface ScalebarCssResource extends CssResource {
	...
	/** Style for the {@link org.geomajas.gwt2.client.widget.control.scalebar.Scalebar}. Provides the background. */
	@ClassName("gm-ScalebarControl")
	String scalebarControl();

	/** Style for the scale bar in the {@link org.geomajas.gwt2.client.widget.control.scalebar.Scalebar}. */
