...
public interface ZoomControlCssResource extends CssResource {
	...
	/** The top style of the {@link org.geomajas.gwt2.client.widget.control.zoom.ZoomControl}. */
	@ClassName("gm-ZoomControl")
	String zoomControl();

	/** Zoom in button in the {@link org.geomajas.gwt2.client.widget.control.zoom.ZoomControl}. */
	...
	/**
	 * Zoom out button in the {@link org.geomajas.gwt2.client.widget.control.zoom.ZoomControl} when being touched.
	 */
