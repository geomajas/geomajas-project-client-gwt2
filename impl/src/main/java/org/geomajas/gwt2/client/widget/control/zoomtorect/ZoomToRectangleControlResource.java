...
public interface ZoomToRectangleControlResource extends ClientBundle {
	...
	/** Icon for the {@link org.geomajas.gwt.client.widget.control.ZoomToRectangleWidget}. */
	@Source("image/map-zoom-to-rect.png")
	@ImageOptions(repeatStyle = RepeatStyle.None)
	ImageResource zoomToRectangle();

	/** Icon for the {@link org.geomajas.gwt.client.widget.control.ZoomToRectangleWidget} when highlighted. */
