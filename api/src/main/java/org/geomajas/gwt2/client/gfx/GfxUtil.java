...
public interface GfxUtil {
	 ...
	 * @param dashArray     whitespace separated list of dashes and gap lengths. If null, the property is
	 *                      omitted/removed.
	 */
	...
	/**
	 * Apply the style defined within the <code>style</code> object on the given vector object.
	 *
	 * @param object The vector object to style.
	 * @param style  The style to apply.
	 */
	void applyStyle(VectorObject object, ShapeStyle style);

	/**
	 * Apply the given controller onto the given object.
	 *
	 * @param object        The object in need of a controller.
