...
import org.geomajas.gwt2.plugin.print.client.event.DefaultPrintRequestHandler;
...
import org.geomajas.gwt2.plugin.print.client.template.impl.DefaultTemplateBuilder;
...
/**
 * Panel for example: calling {@link org.geomajas.gwt2.plugin.print.client.PrintService}.
 * 
...
public class PrintExamplePrintServicePanel implements SamplePanel {
	...
	private class CustomPrintRequestHandler extends DefaultPrintRequestHandler {
		...
		/**
		 * Default {@link org.geomajas.gwt2.plugin.print.client.event.PrintRequestFinishedEvent}. Can be overwritten.
		 * @param event event
		 */
		@Override
