...
import org.geomajas.gwt2.plugin.print.component.LayoutConstraint;
...
public class RasterLayerComponentImpl extends BaseLayerComponentImpl<RasterLayerComponentInfo> {
	...
	private static final String BUNDLE_NAME = "org/geomajas/gwt2/extension/print/rasterlayercomponent"; //$NON-NLS-1$
