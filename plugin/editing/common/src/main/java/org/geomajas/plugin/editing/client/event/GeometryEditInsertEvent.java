...
/**
 * Event which is passed when some part of a geometry has been inserted during geometry editing.
 * 
...
public class GeometryEditInsertEvent extends AbstractGeometryEditEvent<GeometryEditInsertHandler> {
	...
	protected void dispatch(GeometryEditInsertHandler handler) {
		handler.onGeometryEditInsert(this);
	}
}