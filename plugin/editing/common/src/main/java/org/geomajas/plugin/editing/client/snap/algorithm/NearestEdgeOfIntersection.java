...
/**
 * <p> Snapping algorithm that snaps to both end-points and any point on an edge of intersecting geometries. Only
 * geometries with closed rings that actually intersect the given coordinate are considered for snapping. All other
 * geometries are discarded. </p>
 *
