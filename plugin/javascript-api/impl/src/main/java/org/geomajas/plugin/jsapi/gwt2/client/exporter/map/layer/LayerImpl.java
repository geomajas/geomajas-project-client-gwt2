...
public class LayerImpl implements Layer, Exportable {
	...
	protected org.geomajas.gwt2.client.map.layer.Layer layer;
	 ...
	 * @since 1.0.0
	 */
	public LayerImpl(org.geomajas.gwt2.client.map.layer.Layer layer) {
		this.layer = layer;
	}
	...
	public String getServerLayerId() {
		if (layer instanceof ServerLayer) {
			return ((ServerLayer<?>) layer).getServerLayerId();
		} else {
			return layer.getId();
		}
	}
	 ...
	 * 
	 * @param selected The boolean value that indicates whether or not to select this layer.
	 */
	 ...
	 * 
	 * @param markedAsVisible Should the layer be marked as visible or invisible?
	 */
