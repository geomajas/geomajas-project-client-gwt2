 ...
 */
package org.geomajas.plugin.jsapi.gwt2.client.exporter;
...
import org.geomajas.plugin.jsapi.gwt2.client.exporter.spatial.BboxServiceImpl;
import org.geomajas.plugin.jsapi.gwt2.client.exporter.spatial.GeometryServiceImpl;
...
public final class GeomajasServiceImpl implements Exportable, GeomajasService {
	...
	public Map createMap(String applicationId, String mapId, String elementId) {
		...
		if (map == null) {
			...
			GeomajasServerExtension.getInstance().initializeMap(mapPresenter, applicationId, mapId);
