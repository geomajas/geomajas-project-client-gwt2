...
/**
 * {@link BaseGeometryPath} objects are standard Geometry Resizable objects.
 *
 * @author Jan De Moerloose
 * @author Jan Venstermans
 */
public class BaseGeometryPath extends BaseGraphicsObject implements GeometryEditable,
		Resizable, Draggable, Fillable, Strokable {
	...
	public BaseGeometryPath(Geometry geometry) {
	...
	public GraphicsObject cloneObject() {
		BaseGeometryPath clone = new BaseGeometryPath(getGeometry());
		return clone;
	}
