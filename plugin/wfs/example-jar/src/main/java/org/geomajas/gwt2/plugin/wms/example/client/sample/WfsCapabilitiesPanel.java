...
public class WfsCapabilitiesPanel implements SamplePanel {
	...
	private static final String WFS_BASE_URL = "http://apps.geomajas.org/geoserver/demo_world/ows";
	...
	private void getCapabilities() {
		...
		WfsClient.getInstance().getWfsService()
				.getCapabilities(WfsVersion.V1_0_0, WFS_BASE_URL, new Callback<WfsGetCapabilitiesInfo, String>() {
									...
									public void onValueChange(ValueChangeEvent<Boolean> event) {
										if (event.getValue()) {
											...
											mapPresenter.getLayersModel().addLayer(
													new SimpleWfsLayer(WFS_BASE_URL, layerInfo, layerInfo.getName(),
