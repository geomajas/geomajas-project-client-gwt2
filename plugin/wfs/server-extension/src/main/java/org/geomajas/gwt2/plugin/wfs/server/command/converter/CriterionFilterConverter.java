 ...
 * 
 */
public class CriterionFilterConverter implements CriterionDtoVisitor {

	private final Logger log = LoggerFactory.getLogger(CriterionFilterConverter.class);
	...
	public CriterionFilterConverter(FilterService filterService, DtoConverterService converterService) {
