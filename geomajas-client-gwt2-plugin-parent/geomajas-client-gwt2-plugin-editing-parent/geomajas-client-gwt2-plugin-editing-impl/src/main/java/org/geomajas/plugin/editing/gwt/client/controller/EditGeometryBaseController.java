...
public class EditGeometryBaseController extends AbstractMapController {
	...
	public void onActivate(MapPresenter mapPresenter) {
		...
		insertController.setMaxBounds(mapPresenter.getConfiguration().getMapOptions().getMaxBounds());
		dragController.setMaxBounds(mapPresenter.getConfiguration().getMapOptions().getMaxBounds());
	}
